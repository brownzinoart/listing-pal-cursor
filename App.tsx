...
const AppRoutes = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-background overflow-x-hidden">
      ...
      <main
        className={`flex-grow ${!usesModernLayout ? "container mx-auto px-4 py-8" : ""} overflow-hidden`}
      >
        <Routes>
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <DashboardPage section="interior" />
              </PrivateRoute>
            }
          />
          <Route
            ...
            element={
              <PrivateRoute>
                <DashboardPage section="descriptions" />
              </PrivateRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <DashboardPage section="resources" />
              </PrivateRoute>
            }
          />
          <Route
            path="/dashboard/resources/workflow"
            element={
              <PrivateRoute>
                <RealEstateWorkflow />
              </PrivateRoute>
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <ListingDescriptionGeneratorPage />
              </PrivateRoute>
            }
          />
          <Route
