...
const DashboardPage: React.FC<DashboardPageProps> = ({ section }) => {
  ...
  const Sidebar = () => (
    <aside
      className={`fixed z-30 inset-y-0 left-0 w-64 transform transition-transform duration-200 ease-in-out
        ...
        <div className="relative w-full flex flex-col items-center">
          ...
          {showSettings && (
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-52 bg-gray-900 text-white border border-brand-border rounded-md shadow-lg z-50">
              <Link to="/account" className="block px-4 py-2 hover:bg-gray-800">
                Account Details
              </Link>
              <Link
                to="/subscription"
        ...
        {(!section || section === "dashboard") && (
          <>
            ...
            {isLoading ? (
              ...
              <p className="text-center text-brand-danger bg-red-900/20 p-4 rounded-md">
                {error}
              </p>
            ) : listings.length === 0 ? (
              <div className="text-center py-12 bg-brand-panel rounded-lg shadow-xl border border-brand-border">
                ...
                <p className="text-xl text-brand-text-secondary mb-2">
                  No listings yet.
                </p>
        ...
        {section &&
          ...
          section !== "social" && (
            <div className="flex flex-col items-center justify-center h-full p-12">
              <h2 className="text-2xl font-bold text-brand-text-primary mb-2 capitalize">
              ...
              <div className="mt-8 text-brand-text-tertiary">
                (Coming soon in Beta!)
              </div>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {RESOURCE_CARDS.map((card) => (
                ...
                >
                  ...
                  <span className="text-brand-primary font-medium mt-auto group-hover:underline">
                    Open
                  </span>
                </div>
              ))}
            ...
            >
              <div className="flex items-center justify-center min-h-screen px-4">
                ...
                <div className="relative bg-white rounded-xl shadow-xl max-w-lg w-full mx-auto p-8 z-10">
                  <Dialog.Title className="text-2xl font-bold mb-4 text-brand-text-primary">
                    Contract Helper
                  </Dialog.Title>
                  <div className="mb-4">
                    <label className="block text-sm font-medium mb-1 text-brand-text-secondary">
                      Select State
                    </label>
                    <select
                  ...
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold mb-2 text-brand-text-primary">
