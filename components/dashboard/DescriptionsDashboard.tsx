...
const DescriptionsDashboard: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span
        className={`px-3 py-1 text-xs font-medium rounded-full border ${styles[status as keyof typeof styles] || "bg-slate-500/20 text-slate-400 border-slate-500/30"}`}
      >
  ...
  const renderDescriptionsTable = (
    descriptions: typeof mockDescriptionVersions,
    title: string,
  ) => (
              ...
              {descriptions.map((description) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 rounded-full text-xs border ${getVersionBadgeColor(description.version)}`}
                    >
                      {description.version}
                    </span>
                  </td>
