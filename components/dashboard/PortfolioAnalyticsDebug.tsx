      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-6">
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>
              Switch back to full PortfolioAnalyticsDashboard once this works
            </li>
          </ol>
        </div>
        ...
        <div className="bg-gray-100 border border-gray-400 text-gray-700 px-4 py-3 rounded">
          ...
          <p className="mb-2">
            Try navigating to other dashboard sections and back to verify
            navigation works:
          </p>
          <div className="space-x-2">
            ...
            <a href="/dashboard/social" className="text-blue-600 underline">
              Social Posts
            </a>
            <a href="/dashboard/ads" className="text-blue-600 underline">
              Paid Ads
            </a>
            <a href="/dashboard/portfolio" className="text-blue-600 underline">
              Portfolio (this page)
            </a>
          </div>
        </div>
