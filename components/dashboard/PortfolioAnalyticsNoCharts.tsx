...
const leadQualityData = generateLeadQualityData();
const marketingChannelData = getMarketingChannelData();
...
const PortfolioAnalyticsNoCharts: React.FC = () => {
  ...
  return (
    <PortfolioErrorBoundary>
      <DashboardWrapper
        title="Portfolio Analytics (No Charts Version)"
        subtitle="Testing portfolio analytics without chart components"
        showFilters={true}
        showExport={true}
                      ...
                      <tr key={listing.id} className="hover:bg-brand-background/50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          ...
                          {performance && performance.virtualTourViews > 0 && (
                            <div className="text-xs text-brand-text-secondary">
                              {performance.virtualTourViews} virtual tours
                            </div>
                          )}
                        </td>
                        <td className="px-4 py-3">
                          ...
                          {performance && performance.showings > 0 && (
                            <div className="text-xs text-brand-text-secondary">
                              {performance.showings} showings
                            </div>
                          )}
                        </td>
                        <td className="px-4 py-3">
                          ...
                          {performance && performance.favorites > 0 && (
                            <div className="text-xs text-brand-text-secondary">
                              {performance.favorites} favorites
                            </div>
                          )}
                        </td>
                      </tr>
...
export default PortfolioAnalyticsNoCharts;