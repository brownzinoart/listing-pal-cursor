...
const SocialPostComposer: React.FC<SocialPostComposerProps> = ({
  post,
  onClose,
  onSave,
}) => {
  ...
  const handleGenerateContent = () => {
    ...
    setHashtags(
      [...commonHashtags.slice(0, 3), ...platformHashtags[activePlatform]].join(
        " ",
      ),
    );
  };
          ...
          <div className="p-6 max-h-[80vh] overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    {(
                      Object.entries(platformData) as [
                        Platform,
                        (typeof platformData)[Platform],
                      ][]
                    ).map(([platform, data]) => (
                      <button
                        key={platform}
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-xs text-brand-text-secondary">
                      {content.length} /{" "}
                      {platformData[activePlatform].charLimit} characters
                    </span>
                    {content.length >
                      platformData[activePlatform].charLimit && (
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3">
                      <input
                        ...
                        onChange={(e) =>
                          setStatus(e.target.value as SocialPost["status"])
                        }
            ...
            <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-brand-border">
              ...
              <Button
                ...
                onClick={handleSave}
                disabled={
                  !content || !selectedListing || selectedPlatforms.length === 0
                }
              >
                {selectedPlatforms.length > 1
