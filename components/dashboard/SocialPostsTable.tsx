          ...
          <table className="w-full">
            <thead className="bg-white/5 border-b border-white/10">
              <tr>
                ...
                <th
                  className="text-center px-6 py-4 text-xs font-semibold text-slate-300 uppercase tracking-wider cursor-pointer"
                ...
                <div className="lg:w-80 space-y-4">
                  ...
                  {post.status === "published" ? (
                    ...
                    <div className="bg-white/5 rounded-lg p-4 text-center">
                      <p className="text-slate-400 text-sm">
                        Performance metrics will appear after publishing
                      </p>
                    </div>
                  )}
              ...
              <div className="w-16 h-16 mx-auto mb-6 bg-slate-500/20 rounded-2xl flex items-center justify-center">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M7 8h10m0 0V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2m0 0v8a2 2 0 002 2h6a2 2 0 002-2V8m0 0H7m5 5v3"
                  />
                </svg>
              </div>
