...
const VideoStudioDashboard: React.FC = () => {
  ...
  const avgEngagement =
    videos
      .filter((v) => v.metrics)
      .reduce((sum, v) => sum + (v.metrics?.engagement || 0), 0) /
      publishedVideos || 0;
                    ...
                    <div className="flex items-center gap-4 mt-4">
                      ...
                      <div className="flex items-center gap-2">
                        {video.platforms.tiktok && (
                          <FaTiktok className="h-4 w-4 text-slate-300" />
                        )}
                        {video.platforms.instagram && (
                          <FaInstagram className="h-4 w-4 text-slate-300" />
                        )}
                        {video.platforms.youtube && (
                          <FaYoutube className="h-4 w-4 text-slate-300" />
                        )}
                      </div>
                    </div>
          ...
          {videos.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 mb-6">
                Create your first property video to get started
              </p>
              <Button
                variant="gradient"
                leftIcon={<PlusIcon className="h-5 w-5" />}
