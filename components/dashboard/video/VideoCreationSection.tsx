...
const VideoCreationSection: React.FC<VideoCreationSectionProps> = ({ onClose, template }) => {
  const { user } = useAuth();
            ...
            <div className="bg-white/5 border border-white/20 rounded-2xl p-8">
              ...
              {isLoadingDemo && (
                <div className="mt-6 text-center">
                  ...
                  <p className="text-sm text-slate-400">Loading demo property images...</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              {uploadedImages.length > 0 && (
                <div className="mt-6">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-white">{uploadedImages.length} images uploaded</p>
                    {selectedDemoProperty && (
                      <p className="text-sm text-purple-400">High-quality images from Unsplash</p>
                    )}
                  </div>
                      ...
                      <div key={index} className="relative aspect-square rounded-lg overflow-hidden bg-slate-700 group">
                        ...
                        <img
                          ...
                          className={`w-full h-full object-cover transition-opacity ${
                            imageLoadStatus[index] === 'loading' ? 'opacity-0' : 'opacity-100'
                          }`}
              ...
              <div className="mt-8">
                ...
                <p className="text-slate-400 text-sm mb-4">Click the play button to preview each voice</p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <div className="flex items-center gap-3 mb-2">
                            <UserIcon className={`h-5 w-5 ${voice.gender === 'female' ? 'text-pink-400' : 'text-blue-400'}`} />
                            <div>
                              <h5 className={`font-semibold ${
                                selectedVoice === voice.id ? 'text-white' : 'text-slate-300'
                              }`}>
                                {voice.name}
                              </h5>
              ...
              <div className="mt-8">
                ...
                <p className="text-slate-400 text-sm mb-4">Choose where you want to publish your video - we'll optimize for each platform</p>
