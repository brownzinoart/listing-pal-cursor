...
const VideoCreationWizard: React.FC<VideoCreationWizardProps> = ({
      ...
      switch (currentStep) {
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          const mockListing = {
                            ...
                            description:
                              "Beautiful demo property for testing video creation",
                            features: [
                              "Modern kitchen",
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-400 text-sm mb-6">
                  Upload high-quality images of the property. The AI will
                  analyze and arrange them optimally.
                </p>
          ...
          return (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 mb-6">
                AI is analyzing your property images...
              </p>
              <Button
                variant="gradient"
                onClick={() => {
        ...
        case "script":
          return (
            <div className="text-center py-12">
              <h3 className="text-white text-lg mb-4">
                Script Generation (Coming Soon)
              </h3>
              <p className="text-slate-400 mb-6">
                AI is generating your video script...
              </p>
              <Button
                variant="gradient"
                onClick={() => {
                  ...
                  setScript({
                    ...
                    scenes: [
                      {
                        imageIndex: 0,
                        narration: "This stunning living room features...",
                        duration: 10,
                      },
                      {
                        imageIndex: 1,
                        narration: "The modern kitchen includes...",
                        duration: 10,
                      },
                    ],
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setGeneratedVideo({
                    ...
                    platformVersions: {
                      tiktok: {
                        url: "/api/placeholder/video/tiktok.mp4",
                        duration: 60,
                      },
                      instagram: {
                        url: "/api/placeholder/video/instagram.mp4",
                        duration: 90,
                      },
                      youtube: {
                        url: "/api/placeholder/video/youtube.mp4",
                        duration: 120,
                      },
                    },
                  });
        ...
        case "publish":
          return (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 mb-6">
                Publishing your video to social platforms...
              </p>
              <Button
                variant="gradient"
      ...
      return (
        <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-8 text-center">
          ...
          <p className="text-slate-400 mb-4">
            There was an error loading this step. Please try refreshing or
            contact support.
          </p>
          <Button
            variant="ghost"
  ...
  const canProceed = () => {
    switch (currentStep) {
      case "property":
        return selectedListing !== null && listings.length > 0;
      case "upload":
