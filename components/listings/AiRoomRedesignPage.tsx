  ...
  if (error && !listing) {
    ...
    return (
      <div className="text-center py-10">
        <p className="text-brand-danger bg-red-900/30 p-4 rounded-md max-w-md mx-auto">
          {error}
        </p>
  ...
  return (
    <div className="min-h-screen bg-brand-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <p className="text-brand-text-secondary mb-1 mt-1">
          For: {listing.address.split(",")[0]}
        </p>
        <p className="text-brand-text-tertiary mb-2 text-sm">
          Upload a clear photo of the room you want to redesign and generate a
          new look.
        </p>
        <p className="text-brand-text-tertiary mb-8 text-xs">
          💡 Tip: Photos taken with your phone camera work perfectly! Just make
          sure the room is well-lit and clearly visible.
        </p>
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-md cursor-pointer hover:border-brand-primary transition-colors ${uploadedImage ? "border-brand-primary" : "border-brand-border"}`}
                >
                ...
                <label
                  ...
                  className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-brand-border rounded-md cursor-pointer hover:border-brand-primary transition-colors"
                >
              ...
              {uploadedImage && (
                <div className="mb-4">
                  ...
                  />
                  <p className="text-sm text-brand-text-secondary mt-2 text-center">
                    {uploadedImageName}
                  </p>
                </div>
              )}
              ...
              {fileError && (
                <p className="text-xs text-brand-danger mt-2">{fileError}</p>
              )}
            </div>
        ...
        {error && !isGenerating && (
          <div className="my-4 p-3 bg-brand-danger/20 text-brand-danger text-sm rounded-md flex items-center">
        ...
        <Button
          ...
          leftIcon={
            isGenerating ? undefined : <SparklesIcon className="h-5 w-5" />
          }
          size="lg"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              <div>
                ...
                <img
                  src={uploadedImage!}
                  alt="Original room"
                  className="w-full rounded-md shadow-md border border-brand-border"
                />
              </div>
              <div>
                <h3 className="text-lg font-medium text-brand-text-secondary mb-2">
                  Redesigned (
                  {AI_DESIGN_STYLES.find((s) => s.id === selectedDesignStyle)
                    ?.name || "Style"}
                  )
                  <Button
                    size="sm"
                ...
                <img
                  ...
                  alt="Redesigned room"
                  className="w-full rounded-md shadow-md border border-brand-primary"
                />
              </div>
            </div>
            {/* Workflow Actions */}
