              ...
              for (;;) {
                try {
                  ...
                  if (
                    ...
                    imageUrl = content;
                    console.log(
                      "✅ Decor8AI returned immediate result with image URL:",
                      imageUrl,
                    );
                    break;
                  } else {
                    throw new Error(
                      "Decor8AI did not return a valid image URL yet.",
                    );
                  }
                } catch (err) {
                  lastError = err;
                  ...
                  if (waited >= maxWaitMs) {
                    console.error(
                      "❌ Timed out waiting for Decor8AI image URL after 60s:",
                      err,
                    );
                    throw new Error(
                      "Timed out waiting for Decor8AI to return a valid image URL.",
                    );
                  }
                  console.log(
                    `⏳ Waiting for Decor8AI image URL... retrying in ${pollIntervalMs / 1000}s (waited ${Math.round(waited / 1000)}s)`,
                  );
