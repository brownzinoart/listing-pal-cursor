                          ...
                          <div className="text-slate-300 leading-relaxed min-h-[60px] overflow-hidden">
                            ...
                            listing.keyFeatures.trim().length > 0 ? (
                              ...
                              <div className="text-slate-500 italic text-sm break-words">
                                No key features listed. Add features to enhance
                                your listing.
                              </div>
                            )}
                          </div>
              ...
              <div className="relative group mb-12">
                ...
                <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6">
                  ...
                  <p className="text-slate-300">
                    To view neighborhood insights, please edit this listing and
                    re-select the address to ensure proper coordinates are set.
                  </p>
                </div>
              </div>
            )}
