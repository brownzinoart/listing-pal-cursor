              ...
              try {
                ...
                if (
                  ...
                  return (
                    <h4
                      key={`header-${index}`}
                      className="font-bold text-gray-900 text-sm mt-4 first:mt-0 uppercase tracking-wide break-words"
                    >
                      {headerText}
                    </h4>
                  );
                ...
                if (trimmed.startsWith("•") && trimmed.length > 1) {
                  ...
                  return (
                    <div
                      key={`bullet-${index}`}
                      className="flex items-start space-x-2 ml-4 overflow-hidden"
                    >
                      <span className="text-brand-secondary mt-1.5 text-xs flex-shrink-0">
                        •
                      </span>
      ...
      <div className="max-h-80 overflow-y-auto overflow-x-hidden space-y-3">
        {features.map((feature, index) => (
          <div key={`feature-${index}`} className="flex items-start space-x-3">
            <span className="text-brand-primary mt-1 text-sm flex-shrink-0 font-medium">
              •
            </span>
            <span className="text-brand-text-primary text-sm leading-relaxed break-words">
              {feature}
            </span>
          </div>
        ))}
      ...
      .then((data) => {
        if (data && data.userId === user?.id) {
          console.log("📊 Listing loaded successfully:", {
            ...
            hasRoomDesigns: !!(
              data.generatedRoomDesigns && data.generatedRoomDesigns.length > 0
            ),
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 fixed inset-0 overflow-auto">
        ...
        />
        <div
          className={`transition-all duration-300 ${getMainContentMargin()} min-h-full flex items-center justify-center`}
        >
          ...
          <div className="w-full space-y-8">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center space-x-4">
                <PDFExportButton listing={listing} variant="glass" size="lg" />
                        ...
                        {primaryImage ? (
                          <>
                            ...
                            {hasMultipleImages && (
                              <>
                                <button
                                  onClick={prevImage}
                                  className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-lg border border-white/20 text-white p-1.5 sm:p-2 rounded-full hover:bg-white/20 transition-all focus:outline-none"
                                >
                                  <ChevronLeftIcon className="h-4 w-4 sm:h-6 sm:w-6" />
                                </button>
                                <button
                                  onClick={nextImage}
                                  className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-lg border border-white/20 text-white p-1.5 sm:p-2 rounded-full hover:bg-white/20 transition-all focus:outline-none"
                                >
                          ...
                          <div className="w-full h-full flex items-center justify-center overflow-hidden">
                            <div className="text-center text-white px-4">
                              ...
                              <h3 className="text-lg sm:text-xl font-medium break-words">
                                Main Property Image
                              </h3>
                              <p className="text-gray-300 text-sm mt-2 break-words">
                                Upload photos to showcase this listing
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="space-y-4 overflow-hidden">
                          <div className="flex flex-col gap-4 overflow-hidden">
                            <div className="flex-1 min-w-0 overflow-hidden">
                              ...
                              <p className="text-slate-400 text-sm sm:text-base lg:text-lg break-words">
                                {listing.address
                                  .split(",")
                                  .slice(1)
                                  .join(",")
                          ...
                          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 py-4 border-t border-b border-white/20 overflow-hidden">
                            <div className="text-center min-w-0">
                              <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white break-words">
                                {listing.bedrooms}
                              </div>
                  ...
                  <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6 sm:p-8 overflow-hidden">
                    <NeighborhoodInsights
                      ...
                      onSectionToggle={(sections) => {
                        ...
                        setListing((prev) =>
                          prev
                            ? { ...prev, neighborhoodSections: sections }
                            : null,
                        );
                      }}
                    />
                ...
                <div className="relative group mb-12">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6">
                    <h3 className="text-lg font-semibold text-amber-400 mb-2">
                      Neighborhood Insights Unavailable
                    </h3>
                    <p className="text-slate-300">
                      To view neighborhood insights, please edit this listing
                      and re-select the address to ensure proper coordinates are
                      set.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 space-y-8 overflow-hidden">
                    ...
                    <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                        <div className="mb-4 sm:mb-0 min-w-0 flex-1">
                          <h3 className="text-2xl font-bold text-brand-text-primary mb-2 break-words">
                        ...
                        <Link
                          to={`/listings/${listing.id}/generate/description`}
                          className="flex-shrink-0"
                        >
                          <Button
                            variant="edit"
                          ...
                          <div className="bg-brand-background/30 border border-brand-border/50 rounded-lg p-4 overflow-hidden">
                            <div className="flex items-center justify-between mb-4 overflow-hidden">
                              <div className="min-w-0 flex-1">
                                <h4 className="font-semibold text-brand-text-primary text-base break-words">
                                  Facebook Post
                                </h4>
                              ...
                              <Link
                                to={`/listings/${listing.id}/generate/facebook-post`}
                        ...
                        {listing.generatedInstagramCaption && (
                          <div className="bg-brand-background/30 border border-brand-border/50 rounded-lg p-4 overflow-hidden">
                            <div className="flex items-center justify-between mb-4 overflow-hidden">
                              ...
                              <Link
                                to={`/listings/${listing.id}/generate/instagram-post`}
                                className="flex-shrink-0 ml-3"
                              >
                                <Button
                                  variant="edit"
                        ...
                        {listing.generatedXPost && (
                          <div className="bg-brand-background/30 border border-brand-border/50 rounded-lg p-4 overflow-hidden">
                            <div className="flex items-center justify-between mb-4 overflow-hidden">
                              ...
                              <Link
                                to={`/listings/${listing.id}/generate/x-post`}
                                className="flex-shrink-0 ml-3"
                              >
                                <Button
                                  variant="edit"
                  ...
                  {listing.generatedEmail && (
                    <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                        ...
                        <Link
                          to={`/listings/${listing.id}/generate/email`}
                          className="flex-shrink-0"
                        >
                          <Button
                            variant="edit"
                  ...
                  {(() => {
                    ...
                    console.log("🏠 Room designs debug:", {
                      ...
                      isArrayRoomDesigns: Array.isArray(
                        listing.generatedRoomDesigns,
                      ),
                    });
                    ...
                    if (listing.generatedRoomDesigns) {
                      if (Array.isArray(listing.generatedRoomDesigns)) {
                        ...
                        console.log(
                          "✅ Room designs are already an array:",
                          roomDesignsCount,
                        );
                      } else if (
                        typeof listing.generatedRoomDesigns === "string"
                      ) {
                        // String - try to parse as JSON
                        console.log(
                          "⚠️ Room designs stored as string, attempting to parse...",
                        );
                        try {
                          ...
                          if (Array.isArray(parsed)) {
                            ...
                            roomDesignsCount = roomDesigns.length;
                            console.log(
                              "✅ Successfully parsed room designs:",
                              roomDesignsCount,
                            );
                          } else {
                            console.warn(
                              "⚠️ Parsed room designs is not an array:",
                              parsed,
                            );
                          }
                        } catch (e) {
                          console.error(
                            "❌ Failed to parse room designs string:",
                            e,
                          );
                        }
                      }
                    ...
                    return roomDesigns && roomDesignsCount > 0
                      ? roomDesigns
                      : null;
                  })() && (
                    <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-brand-secondary break-words">
                              {(() => {
                                ...
                                if (listing.generatedRoomDesigns) {
                                  if (
                                    Array.isArray(listing.generatedRoomDesigns)
                                  ) {
                                    count = listing.generatedRoomDesigns.length;
                                  } else if (
                                    typeof listing.generatedRoomDesigns ===
                                    "string"
                                  ) {
                                    try {
                                      const parsed = JSON.parse(
                        ...
                        <Link
                          to={`/listings/${listing.id}/ai/room-redesign`}
                          className="flex-shrink-0"
                        >
                          <Button
                            variant="edit"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 overflow-hidden">
                        {(() => {
                          ...
                          if (listing.generatedRoomDesigns) {
                            if (Array.isArray(listing.generatedRoomDesigns)) {
                              ...
                              try {
                                ...
                                console.error(
                                  "Failed to parse room designs in display:",
                                  e,
                                );
                              }
                            }
                          ...
                          return roomDesigns?.map(
                            (design: any, index: number) => {
                              const style: AiDesignStyle | undefined =
                                AI_DESIGN_STYLES.find(
                                  (s) => s.id === design.styleId,
                                );
                              return (
                                <div
                                  key={index}
                                  className="bg-brand-background/30 border border-brand-border/50 rounded-lg overflow-hidden"
                                >
                                  ...
                                  <div className="p-3 sm:p-4 overflow-hidden">
                                    <h4 className="font-semibold text-brand-text-primary text-sm sm:text-base mb-1 break-words">
                                      {style ? style.name : design.styleId}
                                    </h4>
                                    <p className="text-xs text-brand-text-tertiary break-words mb-2">
                                      {new Date(
                                        design.createdAt ?? "",
                                      ).toLocaleDateString()}
                                    </p>
                                    {design.prompt && (
                                      <p className="text-sm text-brand-text-secondary italic break-words">
                                        "{design.prompt}"
                                      </p>
                                    )}
                                  </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                          <div className="mb-4 sm:mb-0 min-w-0 flex-1">
                            ...
                            <div className="flex items-center">
                              <span className="bg-brand-secondary h-2 w-2 rounded-full mr-2"></span>
                              <span className="text-sm font-medium text-brand-secondary break-words">
                                {listing.generatedFlyers.length} flyer
                                {listing.generatedFlyers.length > 1
                                  ? "s"
                                  : ""}{" "}
                                generated
                              </span>
                            ...
                            >
                              ...
                              <div className="p-3 sm:p-4 overflow-hidden">
                                <div className="flex items-center justify-between mb-2 overflow-hidden">
                                  <h4 className="font-semibold text-brand-text-primary text-sm sm:text-base break-words">
                                    Flyer {index + 1}
                                  </h4>
                  ...
                  {listing.generatedAdCopy && (
                    <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                              ...
                              {(() => {
                                try {
                                  ...
                                  return Array.isArray(parsed)
                                    ? `${parsed.length} campaigns generated`
                                    : "Generated";
                                } catch {
                                  return "Generated";
                                }
                        ...
                        <Link
                          to={`/listings/${listing.id}/generate/paid-ad`}
                          className="flex-shrink-0"
                        >
                          <Button
                            variant="edit"
                              ...
                              <div className="space-y-4 overflow-hidden">
                                {parsedCampaigns.map(
                                  (ad: any, index: number) => (
                                    <div
                                      key={index}
                                      className="bg-brand-background/30 border border-brand-border/50 rounded-lg p-4 sm:p-6 overflow-hidden"
                                    >
                                      ...
                                      <p className="text-brand-text-primary font-medium mb-1 break-words">
                                        {ad.headline}
                                      </p>
                                      <p className="text-brand-text-secondary text-sm mb-2 whitespace-pre-line break-words">
                                        {ad.body}
                                      </p>
                                      <p className="text-brand-primary text-sm font-semibold break-words">
                                        {ad.cta}
                                      </p>
                                    </div>
                                  ),
                        ...
                        return (
                          <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="flex items-center justify-between mb-3 overflow-hidden">
                              <div className="flex items-center space-x-2 min-w-0">
                                <BuildingOfficeIcon className="h-5 w-5 text-brand-primary flex-shrink-0" />
                                <h4 className="font-semibold text-brand-text-primary text-base">
                                  Ad Campaign Copy
                                </h4>
                              </div>
                              <Button
