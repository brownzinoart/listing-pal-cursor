              ...
              try {
                ...
                if (
                  ...
                  return (
                    <h4
                      key={`header-${index}`}
                      className="font-bold text-brand-text-primary text-sm mt-4 first:mt-0 uppercase tracking-wide break-words"
                    >
                      {headerText}
                    </h4>
                  );
                ...
                if (trimmed.startsWith("•") && trimmed.length > 1) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-sm text-brand-text-secondary leading-relaxed break-words">
                        {bulletText}
                      </span>
                    </div>
                  );
                ...
                if (trimmed.length > 0) {
                  return (
                    <p
                      key={`text-${index}`}
                      className="text-sm text-brand-text-secondary leading-relaxed break-words"
                    >
                      {trimmed}
                    </p>
                  );
    ...
    return (
      <div className="flex flex-wrap items-start gap-1.5 max-h-60 overflow-y-auto overflow-x-hidden">
        {features.map((feature, index) => (
          <span
            key={`feature-${index}`}
            className="inline-block bg-brand-border/50 text-brand-text-secondary text-xs px-2 py-1 rounded-full break-words"
          >
            {feature}
          </span>
        ))}
                    ...
                    <div className="mb-4 sm:mb-0 min-w-0 flex-1">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm font-medium text-brand-secondary break-words">
                          {listing.generatedRoomDesigns.length} redesign
                          {listing.generatedRoomDesigns.length > 1
                            ? "s"
                            : ""}{" "}
                          generated
                        </span>
            ...
            {listing.generatedFlyers && listing.generatedFlyers.length > 0 && (
              <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                  ...
                  <Link
                    to={`/listings/${listing.id}/generate/flyer`}
                    className="flex-shrink-0"
                  >
                    <Button
                      variant="edit"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 overflow-hidden">
                  <div className="mb-4 sm:mb-0 min-w-0 flex-1">
                    ...
                    <div className="flex items-center">
                      <span className="bg-brand-secondary h-2 w-2 rounded-full mr-2"></span>
                      <span className="text-sm font-medium text-brand-secondary break-words">
                        {listing.generatedAdCopy.length} campaign
                        {listing.generatedAdCopy.length > 1 ? "s" : ""}{" "}
                        generated
                      </span>
                    </div>
                  </div>
                  <Link
                    to={`/listings/${listing.id}/ai/paid-ads`}
                    className="flex-shrink-0"
                  >
                    <Button
                      variant="edit"
                      ...
                      <div className="flex items-center justify-between mb-3 overflow-hidden">
                        <div className="flex items-center space-x-2 min-w-0">
                          ...
                          <h4 className="font-semibold text-brand-text-primary text-base truncate capitalize">
                            {ad.platform} •{" "}
                            {ad.objective.toLowerCase().replace("_", " ")}
                          </h4>
                        </div>
                        <Button
                          variant="secondary"
