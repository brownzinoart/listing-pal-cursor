...
const ListingDetailPage: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-brand-background flex items-center justify-center">
        <div className="text-center">
          <p className="text-brand-danger bg-red-900/20 p-4 rounded-md">
            {error}
          </p>
        </div>
      </div>
                ...
                <>
                  ...
                  {hasMultipleImages && (
                    <>
                      <button
                        onClick={prevImage}
                        className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 bg-black/40 text-white p-1.5 sm:p-2 rounded-full hover:bg-black/60 transition-all focus:outline-none"
                      >
                        <ChevronLeftIcon className="h-4 w-4 sm:h-6 sm:w-6" />
                      </button>
                      <button
                        onClick={nextImage}
                        className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 bg-black/40 text-white p-1.5 sm:p-2 rounded-full hover:bg-black/60 transition-all focus:outline-none"
                      >
                  ...
                  >
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-brand-card border-2 border-dashed border-brand-border rounded-lg flex items-center justify-center cursor-pointer hover:border-brand-primary hover:bg-brand-primary/10 transition-all group">
                      <div className="text-center">
                        ...
                        <span className="text-xs text-blue-600 group-hover:text-brand-primary">
                          Add
                        </span>
                      </div>
                    </div>
              ...
              <div className="space-y-4 overflow-hidden">
                <div className="flex flex-col gap-4 overflow-hidden">
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-brand-text-primary mb-2 break-words">
                      {listing.address.split(",")[0]}
                    </h1>
                    <p className="text-brand-text-secondary text-sm sm:text-base lg:text-lg break-words">
                      {listing.address.split(",").slice(1).join(",").trim()}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 py-4 border-t border-b border-brand-border overflow-hidden">
                  <div className="text-center min-w-0">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-brand-text-primary break-words">
                      {listing.bedrooms}
                    </div>
                    <div className="text-xs sm:text-sm text-brand-text-secondary break-words">
                      Bedrooms
                    </div>
                  </div>
                  <div className="text-center min-w-0">
                ...
                <div className="overflow-hidden">
                  <h3 className="text-base sm:text-lg font-semibold text-brand-text-primary mb-3 break-words">
                    Key Features
                  </h3>
                  <div className="text-brand-text-secondary leading-relaxed min-h-[60px] overflow-hidden">
                    ...
                    listing.keyFeatures.trim().length > 0 ? (
                      ...
                      <div className="text-brand-text-tertiary italic text-sm break-words">
                        No key features listed. Add features to enhance your
                        listing.
                      </div>
                    )}
                  </div>
          ...
          <section className="bg-brand-panel border border-brand-border rounded-xl p-6 sm:p-8 shadow-xl overflow-hidden">
            <NeighborhoodInsights
              ...
              onSectionToggle={(sections) => {
                ...
                setListing((prev) =>
                  prev ? { ...prev, neighborhoodSections: sections } : null,
                );
              }}
            />
          </section>
                  ...
                  {(() => {
                    ...
                    return roomDesigns?.map((design: any, index: number) => {
                      const style: AiDesignStyle | undefined =
                        AI_DESIGN_STYLES.find((s) => s.id === design.styleId);
                      return (
                        <div
                          key={index}
                  ...
                  <div className="mb-4 sm:mb-0 min-w-0 flex-1">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-brand-secondary break-words">
                        ...
                        {listing.generatedFlyers.length > 1 ? "s" : ""}{" "}
                        generated
                      </span>
                    </div>
                  </div>
                      ...
                      <div className="p-3 sm:p-4 overflow-hidden">
                        ...
                        <div className="flex items-center space-x-2 mb-3 overflow-hidden">
                          <div
                            ...
                            style={{
                              backgroundColor: flyer.customization.primaryColor,
                            }}
                          ></div>
                          <div
                            className="w-3 h-3 rounded-full flex-shrink-0"
                          ...
                          <div
                            className="w-3 h-3 rounded-full flex-shrink-0"
                            style={{
                              backgroundColor: flyer.customization.accentColor,
                            }}
                          ></div>
                          <span className="text-xs text-brand-text-tertiary break-words">
                            Color Scheme
