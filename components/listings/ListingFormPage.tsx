          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8">
              ...
              <p className="text-slate-400 text-sm mt-3">
                Optional details that will help us generate richer marketing
                content for this listing.
              </p>
            </div>
          </div>
          ...
          <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs text-slate-400 leading-relaxed">
                <p className="mb-1">
                  <strong>Data Sources:</strong> Information displayed comes
                  from Google Places API, Google Custom Search API, public real
                  estate listings, and AI-enhanced insights when real data is
                  limited.
                </p>
                <p>
