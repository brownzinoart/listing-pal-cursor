        ...
        {showStateInfo && (
          <div className="mb-4 bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
            <p className="text-sm text-blue-300">
              Real estate contracts vary significantly by state. Each state has
              specific requirements, disclosures, and procedures. We've tailored
              our contracts to comply with state-specific regulations and common
              practices.
            </p>
          </div>
        )}
      ...
      {selectedState === "NC" && (
        <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-amber-300">
            ...
            <li>
              • Due diligence period allows buyers to terminate for any reason
            </li>
