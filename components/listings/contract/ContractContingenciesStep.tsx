...
const ContractContingenciesStep: React.FC<ContractContingenciesStepProps> = ({
  ...
  const updateContingency = (
    index: number,
    updates: Partial<ContractContingency>,
  ) => {
  ...
  const addContingency = (type: ContractContingency["type"]) => {
    ...
    switch (type) {
      case "inspection":
        ...
        break;
      case "financing":
        newContingency.loanType =
          contractData.financials?.financingType || "conventional";
        break;
      case "sale":
  ...
  const getContingencyTitle = (type: ContractContingency["type"]) => {
    switch (type) {
      case "inspection":
        return "Inspection Contingency";
      case "financing":
        return "Financing Contingency";
      case "appraisal":
        return "Appraisal Contingency";
      case "sale":
        return "Sale of Buyer Property";
      case "other":
    ...
    <div className="space-y-8">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6">
        ...
        <div className="text-blue-300 text-sm space-y-2">
          <p>
            <strong>Contingencies</strong> are conditions that must be met for
            the contract to proceed. If a contingency is not satisfied, the
            buyer can typically terminate the contract and receive their earnest
            money back.
          </p>
          <p>
            <strong>NC Note:</strong> All contingency deadlines should fall
            within the due diligence period for maximum buyer protection.
          </p>
        </div>
      </div>
              ...
              <div className="flex items-center gap-3">
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      updateContingency(index, { included: e.target.checked })
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContingency(index, { deadline: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContingency(index, { details: e.target.value })
                      }
                      className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  ...
                  <div className="space-y-4">
                        ...
                        {inspectionTypes.map((type) => (
                          ...
                          >
                            <input
                              type="checkbox"
                              checked={
                                contingency.inspectionTypes?.includes(
                                  type.value,
                                ) || false
                              }
                              onChange={(e) => {
                                const current =
                                  contingency.inspectionTypes || [];
                                const updated = e.target.checked
                                  ? [...current, type.value]
                                  : current.filter((t) => t !== type.value);
                                updateContingency(index, {
                                  inspectionTypes: updated,
                                });
                              }}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        Maximum amount seller agrees to pay for repairs
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateContingency(index, { loanType: e.target.value })
                        }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateContingency(index, {
                            expectedSaleDate: e.target.value,
                          })
                        }
                        className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                      />
          ...
          {[
            {
              ...
              label: "Inspection",
              disabled: contingencies.some((c) => c.type === "inspection"),
            },
            {
              type: "financing" as const,
              label: "Financing",
              disabled: contingencies.some((c) => c.type === "financing"),
            },
            {
              type: "appraisal" as const,
              label: "Appraisal",
              disabled: contingencies.some((c) => c.type === "appraisal"),
            },
            {
              type: "sale" as const,
            ...
            >
              <PlusIcon
                className={`h-4 w-4 mx-auto mb-1 ${item.disabled ? "text-slate-500" : "text-emerald-400"}`}
              />
      ...
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6">
        ...
        <div className="text-amber-300 text-sm space-y-2">
          <p>
            In North Carolina, the due diligence period provides buyers with an
            unrestricted right to terminate the contract for any reason. For
            maximum protection:
          </p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>
              All contingency deadlines should fall within the due diligence
              period
            </li>
            <li>
              The due diligence period serves as a backup protection if
              contingencies aren't met
            </li>
            <li>
              Consider extending the due diligence period if you need more time
              for contingencies
            </li>
          </ul>
        </div>
