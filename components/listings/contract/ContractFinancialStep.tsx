...
const ContractFinancialStep: React.FC<ContractFinancialStepProps> = ({
  ...
  const suggestedEarnestMoney = Math.max(
    Math.round(financials.purchasePrice * 0.01),
    1000,
  );
  ...
  const calculateLoanAmount = () => {
    ...
    if (financials.downPaymentPercentage) {
      return (
        ...
        financials.purchasePrice * (financials.downPaymentPercentage / 100)
      );
    }
  ...
  useEffect(() => {
    ...
    financials.downPaymentPercentage,
  ...
  const handleDownPaymentAmountChange = (amount: number) => {
    const percentage =
      amount > 0 ? (amount / financials.purchasePrice) * 100 : 0;
    setFinancials((prev) => ({
      ...prev,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              List price: {formatCurrency(listing.price)}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="flex justify-between text-xs text-slate-400 mt-1">
              ...
              <button
                onClick={() =>
                  updateFinancial("earnestMoneyDeposit", suggestedEarnestMoney)
                }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateFinancial("earnestMoneyHolder", e.target.value)
              }
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              <p className="text-blue-300 text-sm">
                <strong>NC Practice:</strong> Earnest money is typically 1-2% of
                the purchase price and held by the listing agent's brokerage or
                a title company.
              </p>
            </div>
          </div>
      ...
      <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-6">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <button
                  key={option.value}
                  onClick={() =>
                    updateFinancial("closingCostsPaidBy", option.value)
                  }
                  className={`
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Amount seller contributes toward buyer's closing costs
            </p>
          </div>
