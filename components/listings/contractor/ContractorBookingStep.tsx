...
import { Listing, Contractor, ServiceQuoteRequest, ContractorSearchCriteria } from '../../../types';
...
const ContractorBookingStep: React.FC<ContractorBookingStepProps> = ({
  ...
  const [projectUrgency, setProjectUrgency] = useState<'flexible' | 'moderate' | 'urgent'>('flexible');
  ...
  const getEstimatedProjectCost = () => {
    ...
    const urgencyMultiplier = projectUrgency === 'urgent' ? 1.3 : projectUrgency === 'moderate' ? 1.1 : 1.0;
      ...
      <div className="space-y-8">
        ...
        <div className="bg-emerald-500/20 border border-emerald-500/30 rounded-2xl p-8">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Quote Request Sent Successfully!</h3>
          ...
          <div className="bg-white/5 rounded-xl p-6 mb-6">
            <h4 className="text-white font-semibold mb-4">Quote Request Details</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold capitalize">
                    {searchCriteria.projectType?.replace('-', ' ') || 'General Project'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">
                    {new Date(quoteRequest.preferredStartDate || '').toLocaleDateString('en-US', {
                      weekday: 'long',
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold capitalize">{quoteRequest.projectUrgency}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">
                    {formatPrice(quoteRequest.estimatedCost || getEstimatedProjectCost())}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold capitalize">{quoteRequest.contactMethod}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">{listing.city}, {listing.state}</p>
                </div>
              </div>
            </div>
            ...
            {searchCriteria.projectDescription && (
              <div className="mt-6 pt-4 border-t border-white/10">
                ...
                <p className="text-white bg-white/5 rounded-lg p-3">{searchCriteria.projectDescription}</p>
              </div>
            )}
            ...
            {quoteRequest.additionalRequirements && (
              <div className="mt-4">
                ...
                <p className="text-white bg-white/5 rounded-lg p-3">{quoteRequest.additionalRequirements}</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white/5 rounded-xl p-6">
            <h4 className="text-white font-semibold mb-4">Your Selected Contractor</h4>
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 rounded-xl bg-orange-500/20 flex items-center justify-center">
                <WrenchScrewdriverIcon className="h-6 w-6 text-orange-400" />
              </div>
              <div className="flex-1">
                <p className="text-white font-semibold">{contractor.businessName}</p>
                ...
                <div className="flex items-center space-x-1 mt-1">
                  ...
                  <span className="text-slate-400 text-sm ml-2">({contractor.totalReviews} reviews)</span>
                  {contractor.verified && (
        ...
        <div className="bg-orange-500/10 border border-orange-500/20 rounded-2xl p-6">
          <h4 className="text-orange-400 font-semibold mb-3">What Happens Next?</h4>
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-white font-medium text-sm">Initial Contact</p>
                <p className="text-slate-400 text-xs">The contractor will contact you within 4 hours to discuss your project</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-white font-medium text-sm">Site Assessment</p>
                <p className="text-slate-400 text-xs">Schedule an on-site visit to provide accurate project estimates</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">Receive comprehensive quote with timeline and material costs</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">Begin work according to agreed timeline and specifications</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        <h3 className="text-lg font-semibold text-white mb-4">Request Your Quote</h3>
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 rounded-xl bg-orange-500/20 flex items-center justify-center">
            <WrenchScrewdriverIcon className="h-6 w-6 text-orange-400" />
          </div>
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-4 mt-1">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-slate-400 text-sm ml-2">{contractor.overallRating}</span>
              </div>
              {contractor.verified && (
          ...
          <div className="text-right">
            ...
            <p className="text-emerald-400 font-bold text-lg">{formatPrice(contractor.hourlyRate)}/hr</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <label className="block text-slate-300 text-sm mb-2">Preferred Start Date</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-slate-300 text-sm mb-2">Project Urgency</label>
            <select
              value={projectUrgency}
              onChange={(e) => setProjectUrgency(e.target.value as 'flexible' | 'moderate' | 'urgent')}
            ...
            >
              ...
              <option value="urgent">Urgent - ASAP (rush fees may apply)</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        ...
        <div className="space-y-4 mb-6">
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="text-white font-medium">Materials Included in Quote</span>
              <p className="text-slate-400 text-sm">Contractor will provide all necessary materials</p>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Project may require building permits or approvals</p>
            </div>
          </label>
        </div>
        
        <div>
          <label className="block text-slate-300 text-sm mb-2">Additional Requirements or Special Instructions</label>
          <textarea
      ...
      {/* Cost Estimate */}
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        <h4 className="text-white font-semibold mb-4">Estimated Project Cost</h4>
        <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-slate-300">Base Estimate (40 hours)</span>
            <span className="text-white">{formatPrice(contractor.hourlyRate * 40)}</span>
          </div>
          {projectUrgency !== 'flexible' && (
            <div className="flex justify-between items-center mb-2">
              <span className="text-slate-300">Urgency Adjustment</span>
              <span className="text-white">+{projectUrgency === 'urgent' ? '30' : '10'}%</span>
            </div>
          )}
          <div className="border-t border-orange-500/20 pt-2 mt-2">
            <div className="flex justify-between items-center">
              <span className="text-orange-400 font-bold text-lg">Total Estimate</span>
              <span className="text-orange-400 font-bold text-lg">{formatPrice(getEstimatedProjectCost())}</span>
            </div>
          </div>
          <p className="text-slate-400 text-sm mt-2">
            *This is a preliminary estimate. Final cost will be determined after site assessment.
          </p>
        </div>
      </div>
