...
const BUDGET_RANGES = [
  {
    value: "under-1k",
    label: "Under $1,000",
    description: "Small repairs and quick fixes",
  },
  {
    value: "1k-5k",
    label: "$1,000 - $5,000",
    description: "Minor renovations and improvements",
  },
  {
    value: "5k-15k",
    label: "$5,000 - $15,000",
    description: "Moderate projects and upgrades",
  },
  {
    value: "15k-50k",
    label: "$15,000 - $50,000",
    description: "Major renovations and remodels",
  },
  {
    value: "over-50k",
    label: "$50,000+",
    description: "Large-scale projects and custom work",
  },
  {
    value: "flexible",
    label: "Get quotes first",
    description: "Flexible based on contractor estimates",
  },
];
...
const ContractorRequirementsStep: React.FC<ContractorRequirementsStepProps> = ({
  ...
  const isRequirementSelected = (requirement: string) => {
    return (
      searchCriteria.contractorRequirements?.includes(requirement) || false
    );
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        <h4 className="text-white font-semibold mb-4">
          Preferred contractor qualifications (optional)
        </h4>
        <div className="space-y-4">
          <label className="flex items-center space-x-3 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleRequirementToggle("licensed-insured", e.target.checked)
              }
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Contractors with valid licenses and insurance coverage
                </p>
              </div>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleRequirementToggle("highly-rated", e.target.checked)
              }
              className="rounded border-slate-600 bg-slate-800 text-orange-600 focus:ring-orange-500"
            />
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Only show contractors with excellent customer reviews
                </p>
              </div>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleRequirementToggle("experienced", e.target.checked)
              }
              className="rounded border-slate-600 bg-slate-800 text-orange-600 focus:ring-orange-500"
            />
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Contractors with significant industry experience
                </p>
              </div>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleRequirementToggle("certified", e.target.checked)
              }
              className="rounded border-slate-600 bg-slate-800 text-orange-600 focus:ring-orange-500"
            />
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Contractors with industry certifications and specializations
                </p>
              </div>
            </div>
          </label>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-start space-x-2">
              ...
              <span className="text-white">
                {searchCriteria.projectType?.replace("-", " ")} at{" "}
            ...
            <div className="flex items-start space-x-2">
              ...
              <span className="text-white">
                {
                  BUDGET_RANGES.find(
                    (b) => b.value === searchCriteria.budgetRange,
                  )?.label
                }
              </span>
            </div>
            <div className="flex items-start space-x-2">
              ...
              <span className="text-white">
                {searchCriteria.timeframe?.replace("-", " ")}
              </span>
            </div>
            <div className="flex items-start space-x-2">
              <span className="text-slate-400">Search radius:</span>
              <span className="text-white">
                {searchCriteria.searchRadius} miles
              </span>
            </div>
            {searchCriteria.contractorRequirements &&
              searchCriteria.contractorRequirements.length > 0 && (
                <div className="flex items-start space-x-2">
                  <span className="text-slate-400">Requirements:</span>
                  <span className="text-white">
                    {searchCriteria.contractorRequirements.length} qualification
                    {searchCriteria.contractorRequirements.length !== 1
                      ? "s"
                      : ""}{" "}
                    selected
                  </span>
