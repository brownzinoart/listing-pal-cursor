      ...
      <div className="p-3">
        ...
        {captionText && (
            <p className="text-sm text-gray-900 whitespace-pre-line break-words">
                <span className="font-semibold">{profileName}</span> <span className="text-gray-700">{displayedCaption}</span>
            </p>
        )}
        <p className="text-xs text-gray-500 mt-1 cursor-pointer hover:underline">View all 35 comments</p>
