        ...
        <div className="space-y-8">
          ...
          <Card variant="gradient" padding="lg">
            ...
            <div className="space-y-2 text-sm">
              <div>
                <span className="font-medium">Description Style:</span>{" "}
                {selections.description.style}
              </div>
              <div>
                <span className="font-medium">Email Theme:</span>{" "}
                {selections.email.theme}
              </div>
              <div>
                ...
                {selections.roomRedesign.uploadedImage
                  ...
                  : selections.roomRedesign.selectedImageIndex !== null
                    ? `Image ${selections.roomRedesign.selectedImageIndex + 1}`
                    : "None selected"}
              </div>
              <div>
                <span className="font-medium">Room Type:</span>{" "}
                {selections.roomRedesign.roomType}
              </div>
              <div>
