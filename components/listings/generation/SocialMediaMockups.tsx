  ...
  <div className="bg-white rounded-lg p-3 text-xs shadow-sm w-full max-w-sm mx-auto overflow-hidden">
    <div className="flex items-center mb-2 overflow-hidden">
      ...
      <div className="ml-2 min-w-0 flex-1">
        <div className="font-semibold text-gray-900 break-words">Real Estate Agent</div>
        <div className="text-gray-500 text-xs">2 hours ago</div>
      </div>
    </div>
    <p className="text-gray-800 mb-2 break-words" style={{
      display: '-webkit-box',
      WebkitLineClamp: 3,
    ...
    {listingImage && (
      <div className="mb-2 overflow-hidden rounded">
        <img src={listingImage} alt="Property" className="w-full aspect-[4/3] object-cover" />
      </div>
    )}
    <div className="flex items-center justify-between text-gray-500 pt-2 border-t overflow-hidden">
      <div className="flex items-center space-x-4">
        <span className="flex items-center"><HeartIcon className="w-4 h-4 mr-1 flex-shrink-0" /> Like</span>
        <span className="flex items-center"><ChatBubbleOvalLeftIcon className="w-4 h-4 mr-1 flex-shrink-0" /> Comment</span>
        <span className="flex items-center"><ShareIcon className="w-4 h-4 mr-1 flex-shrink-0" /> Share</span>
      </div>
    </div>
  </div>
);
...
const InstagramMockupMini: React.FC<{ content: string; listingImage?: string }> = ({ content, listingImage }) => (
  <div className="bg-white rounded-lg overflow-hidden shadow-sm w-full max-w-sm mx-auto">
    <div className="flex items-center p-3 overflow-hidden">
      ...
      <div className="ml-2 min-w-0 flex-1">
        <div className="font-semibold text-gray-900 text-sm break-words">realestate_agent</div>
      </div>
    </div>
    {listingImage && (
      <div className="overflow-hidden">
        <img src={listingImage} alt="Property" className="w-full aspect-square object-cover" />
      </div>
    )}
    <div className="p-3 overflow-hidden">
      ...
      <p className="text-gray-800 text-sm break-words" style={{
        display: '-webkit-box',
        WebkitLineClamp: 2,
        WebkitBoxOrient: 'vertical',
        overflow: 'hidden'
    ...
    <div className="flex items-start space-x-2 overflow-hidden">
      ...
      <div className="flex-1 min-w-0 overflow-hidden">
        <div className="flex items-center space-x-1 mb-1 overflow-hidden">
          <span className="font-semibold text-gray-900 text-sm break-words">Real Estate Agent</span>
          <span className="text-gray-500 text-xs break-words">@realestate · 2h</span>
        </div>
        <p className="text-gray-800 text-sm mb-2 break-words" style={{
          display: '-webkit-box',
          WebkitLineClamp: 3,
          WebkitBoxOrient: 'vertical',
          overflow: 'hidden'
        ...
        {listingImage && (
          <div className="mb-2 overflow-hidden rounded-lg">
            <img src={listingImage} alt="Property" className="w-full aspect-[16/9] object-cover" />
          </div>
        )}
        <div className="flex items-center justify-between text-gray-500 overflow-hidden">
          <div className="flex items-center space-x-4">
            <span className="flex items-center text-xs"><ChatBubbleOvalLeftIcon className="w-4 h-4 mr-1 flex-shrink-0" /> 12</span>
            <span className="flex items-center text-xs"><ShareIcon className="w-4 h-4 mr-1 flex-shrink-0" /> 8</span>
            <span className="flex items-center text-xs"><HeartIcon className="w-4 h-4 mr-1 flex-shrink-0" /> 25</span>
          </div>
        </div>
      </div>
    </div>
