  ...
  return (
    <div className="space-y-8">
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        <h3 className="text-lg font-semibold text-white mb-4">Inspector Requirements</h3>
        <p className="text-slate-400">This step will allow users to set certification and insurance requirements.</p>
      </div>
