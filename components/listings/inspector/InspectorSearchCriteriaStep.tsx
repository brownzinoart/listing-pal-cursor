...
const INSPECTION_TYPES = [
  ...
  },
  {
    ...
    description: "Check for termites, wood-boring insects, and other pests",
    price: "$75-150",
  },
  {
    id: "radon",
    name: "Radon Testing",
    description: "Test for radon gas levels in the home",
    price: "$125-200",
  },
  {
    id: "mold",
    name: "Mold Assessment",
    description: "Inspection for mold and moisture issues",
    price: "$200-400",
  },
  {
    id: "structural",
    name: "Structural Inspection",
    description: "Detailed assessment of foundation and structural elements",
    price: "$300-500",
  },
  {
    id: "electrical",
    name: "Electrical Inspection",
    description: "Focused inspection of electrical systems",
    price: "$150-250",
  },
  {
    id: "plumbing",
    name: "Plumbing Inspection",
    description: "Detailed check of all plumbing systems",
    price: "$150-250",
  },
  {
    id: "hvac",
...
const InspectorSearchCriteriaStep: React.FC<
  InspectorSearchCriteriaStepProps
> = ({ listing, searchCriteria, onUpdate, onNext, onPrevious }) => {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">
              {listing.squareFootage?.toLocaleString()} sq ft • Built{" "}
              {listing.yearBuilt}
            </p>
          </div>
        </div>
            ...
            <div
              ...
              onClick={() =>
                handlePropertyTypeChange(
                  type.id as "residential" | "commercial",
                )
              }
              className={`
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mb-6">
          Select all inspection types you need. Multiple inspections can often
          be bundled for savings.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {INSPECTION_TYPES.map((type) => {
            const isSelected =
              searchCriteria.inspectionTypes?.includes(type.id) || false;
      ...
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-6">
        ...
        <ul className="text-slate-300 text-sm space-y-1">
          <li>
            • General inspection is recommended for all property purchases
          </li>
