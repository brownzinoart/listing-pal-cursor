...
const FLYER_TEMPLATES = [
  { id: 'modern-luxury', name: 'Modern Luxury', description: 'Clean lines with elegant typography' },
  { id: 'classic-professional', name: 'Classic Professional', description: 'Traditional layout with professional styling' },
  { id: 'minimal-chic', name: 'Minimal Chic', description: 'Minimalist design with maximum impact' },
  { id: 'contemporary-bold', name: 'Contemporary Bold', description: 'Bold colors and modern typography' },
];

const COLOR_SCHEMES = [
  { name: 'Ocean Blue', primary: 'from-blue-600 to-blue-800', secondary: 'bg-blue-100', text: 'text-blue-900' },
  { name: 'Forest Green', primary: 'from-green-600 to-green-800', secondary: 'bg-green-100', text: 'text-green-900' },
  { name: 'Royal Purple', primary: 'from-purple-600 to-purple-800', secondary: 'bg-purple-100', text: 'text-purple-900' },
  { name: 'Sunset Orange', primary: 'from-orange-500 to-red-600', secondary: 'bg-orange-100', text: 'text-orange-900' },
  { name: 'Elegant Black', primary: 'from-gray-800 to-black', secondary: 'bg-gray-100', text: 'text-gray-900' },
];
    ...
    <div className="relative group">
      ...
      <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8">
        <div className="flex items-center mb-6">
          ...
          <h3 className="text-2xl font-bold text-white">Property Flyer Generator</h3>
        </div>
        ...
        <div className="mb-6">
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
            {/* Flyer Header */}
            <div className={`bg-gradient-to-r ${selectedColorScheme.primary} p-6 text-white`}>
            ...
            <div className="p-6">
              <div className="text-center mb-4">
                <div className={`text-4xl font-bold mb-2 bg-gradient-to-r ${selectedColorScheme.primary} bg-clip-text text-transparent`}>
                  {formatPrice(listing.price)}
                </div>
                <div className="flex justify-center space-x-4 text-sm font-medium text-gray-600">
                  {listing.bedrooms && <span className={`${selectedColorScheme.secondary} px-2 py-1 rounded`}>{listing.bedrooms} Beds</span>}
                  {listing.bathrooms && <span className={`${selectedColorScheme.secondary} px-2 py-1 rounded`}>{listing.bathrooms} Baths</span>}
                  {listing.squareFootage && <span className={`${selectedColorScheme.secondary} px-2 py-1 rounded`}>{listing.squareFootage.toLocaleString()} SF</span>}
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  {listing.keyFeatures?.split(',').slice(0, 4).map((feature, index) => (
              ...
              {/* Contact Info */}
              <div className={`bg-gradient-to-r ${selectedColorScheme.primary} text-white p-4 rounded-lg text-center`}>
                <div className="font-bold text-lg">Your Name</div>
                <div className="text-sm opacity-90">Your Phone • Your Email</div>
                <div className="text-xs mt-1">Licensed Real Estate Professional</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {COLOR_SCHEMES.map((scheme) => (
                ...
                >
                  <div className={`w-full h-6 bg-gradient-to-r ${scheme.primary} rounded mb-2`}></div>
          ...
          <Button variant="gradient" fullWidth leftIcon={<PrinterIcon className="h-5 w-5" />}>
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8">
        ...
        {/* Preview */}
        <div className="mb-6">
          <div className={`bg-gradient-to-br ${selectedColor.bg} ${selectedColor.text} p-8 rounded-xl max-w-md mx-auto aspect-[3/2] flex flex-col justify-between shadow-2xl border-4 border-white`}>
            <div className="text-center">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            >
              <option value="small" className="bg-gray-800 text-white">18" x 12" Small</option>
              <option value="standard" className="bg-gray-800 text-white">24" x 18" Standard</option>
              <option value="large" className="bg-gray-800 text-white">30" x 24" Large</option>
            </select>
          </div>
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8">
        ...
        {/* Preview */}
        <div className="mb-6">
          <div className={`bg-gradient-to-r ${selectedColor.bg} text-white p-6 rounded-xl aspect-[5/2] flex relative overflow-hidden shadow-2xl border-4 border-gray-300`}>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            >
              <option value="imageRight" className="bg-gray-800 text-white">Image Right</option>
              <option value="imageLeft" className="bg-gray-800 text-white">Image Left</option>
              <option value="imageBackground" className="bg-gray-800 text-white">Image Background</option>
              <option value="textOnly" className="bg-gray-800 text-white">Text Only</option>
            </select>
          </div>
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8">
        <div className="flex items-center mb-6">
          <div className="text-2xl mr-3">🚪</div>
          <h3 className="text-2xl font-bold text-white">Door Hanger Generator</h3>
        </div>
      ...
      >
        <div className="relative group">
          ...
          <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 text-center">
            ...
            <p className="text-slate-400 mb-4">{error || 'Listing not found'}</p>
      ...
      <div className="space-y-8">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6">
            <h3 className="text-xl font-bold text-white mb-4">Select Print Material Type</h3>
