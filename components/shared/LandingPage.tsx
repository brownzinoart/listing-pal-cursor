...
import { SparklesIcon, HomeModernIcon, ShieldCheckIcon, CpuChipIcon } from '@heroicons/react/24/solid';
    ...
    <div className="flex flex-col items-center justify-center text-center py-12">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl w-full">
        <Card variant="default" padding="lg" className="text-center">
          ...
          <h3 className="text-xl font-semibold mb-2 text-brand-text-primary">Manage Listings</h3>
          <p className="text-brand-text-secondary text-sm">
            Easily create, edit, and organize all your property listings in one place.
          </p>
        </Card>
        
        <Card variant="default" padding="lg" className="text-center">
          <ShieldCheckIcon className="w-12 h-12 text-brand-primary mb-4 mx-auto" />
          <h3 className="text-xl font-semibold mb-2 text-brand-text-primary">Secure Authentication</h3>
          <p className="text-brand-text-secondary text-sm">
        ...
        <Card variant="default" padding="lg" className="text-center">
          ...
          <h3 className="text-xl font-semibold mb-2 text-brand-text-primary">Foundation for AI</h3>
          <p className="text-brand-text-secondary text-sm">
            This phase builds the essential platform for exciting AI-powered marketing tools coming soon.
          </p>
        </Card>
      </div>
    </div>
