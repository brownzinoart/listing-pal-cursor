...
export class NeighborhoodDataService {
  ...
  async fetchComprehensiveData(
    ...
    console.log("Fetching comprehensive neighborhood data...", {
      lat,
      lng,
      address,
    });
    ...
    try {
      ...
      const stateCode = censusService.getStateCode(
        this.getFullStateName(stateAbbr),
      );
      ...
      const walkScore =
        walkScoreData.status === "fulfilled"
          ? walkScoreData.value
          : this.getDefaultWalkScore();
      const amenities =
        amenitiesData.status === "fulfilled"
          ? amenitiesData.value
          : this.getDefaultAmenities();
      const crime =
        crimeData.status === "fulfilled"
          ? crimeData.value
          : this.getDefaultCrimeData();
      const demographics =
        censusData.status === "fulfilled"
          ? censusData.value
          : this.getDefaultCensusData();
      const market =
      ...
      return {
        ...
        schools: {
          ...
          marketingAngles: this.generateEducationMarketingAngles(
            amenities.schools,
          ),
        },
        transportation: {
          ...
          transportationBenefits: this.generateTransportationBenefits(
            walkScore,
  ...
  private async generateAgentTips(
    address: string,
    data: any,
  ): Promise<string[]> {
    try {
  ...
  private generateHighlights(
    ...
    if (walkScore.walkScore > 70) {
      highlights.push(
        `Excellent walkability (${walkScore.walkScore}/100) - most errands can be completed on foot`,
      );
    }

    if (walkScore.transitScore > 70) {
      highlights.push(
        `Great public transit access (${walkScore.transitScore}/100) for easy commuting`,
      );
    }

    if (amenities.restaurants.length > 10) {
      highlights.push(
        `Rich dining scene with ${amenities.restaurants.length}+ restaurants nearby`,
      );
    }

    if (crime.safetyScore > 70) {
      highlights.push(
        `Safe neighborhood with ${fbiCrimeService.getSafetyLabel(crime.safetyScore).toLowerCase()} rating`,
      );
    }

    if (demographics.economics.medianHouseholdIncome > 75000) {
      highlights.push(
        `Affluent area with median income of $${demographics.economics.medianHouseholdIncome.toLocaleString()}`,
      );
    }

    if (demographics.education.bachelorsOrHigher > 50) {
      highlights.push(
        `Highly educated community (${demographics.education.bachelorsOrHigher}% college graduates)`,
      );
    }

    if (market.marketTrend === "seller") {
      highlights.push(
        "Strong seller's market with high demand and limited inventory",
      );
    }
  ...
  private async generatePlacesTalkingPoints(amenities: any): Promise<string[]> {
    ...
    if (amenities.restaurants.length > 0) {
      points.push(
        `${amenities.restaurants.length} dining options within walking distance`,
      );
    }

    if (amenities.shopping.length > 0) {
      points.push(
        `Convenient shopping with ${amenities.shopping.length} retail locations nearby`,
      );
    }

    if (amenities.entertainment.length > 0) {
      points.push(
        `Rich entertainment options with ${amenities.entertainment.length} venues`,
      );
    }
  ...
  private generateSafetyPitch(crime: CrimeData): string[] {
    ...
    pitch.push(
      `Safety score of ${crime.safetyScore}/100 - ${fbiCrimeService.getSafetyLabel(crime.safetyScore)}`,
    );
  ...
  private generateBuyerProfiles(
    ...
    if (demographics.population.medianAge < 35) {
      profiles.push(
        "Young professionals and millennials seeking urban lifestyle",
      );
  ...
  private generateEducationMarketingAngles(schools: GeoapifyPlace[]): string[] {
    ...
    if (schools.length > 0) {
      ...
      angles.push(
        "Highlight educational opportunities for property value stability",
      );
  ...
  private generateTransportationBenefits(
    walkScore: WalkScoreData,
    transportation: GeoapifyPlace[],
  ): string[] {
    const benefits: string[] = [];

    if (walkScore.walkScore > 70) {
      benefits.push(
        "Reduced car dependency saves money on transportation costs",
      );
    }
  ...
  private calculateDataQuality(availability: {
    [key: string]: boolean;
  }): number {
  ...
  private getDemoNeighborhoodData(
    address: string,
    ...
    return {
      overview: {
        walkScore: {
          ...
          transitScore: 78,
          transitDescription:
            "Excellent Transit - Public transportation is convenient for most trips",
          bikeScore: 85,
          bikeDescription:
      ...
      places: {
        ...
        shopping: [
          {
            name: "Demo Plaza Shopping Center",
        ...
        entertainment: [
          ...
          {
            name: "Demo Bowling Alley",
            category: "Bowling",
            distance: 1.0,
            rating: 4.3,
            categories: ["bowling", "recreation"],
          },
          {
        ...
        services: [
          ...
          {
            name: "Demo Post Office",
            category: "Post Office",
            distance: 0.4,
            rating: 4.1,
            categories: ["post_office", "government"],
          },
          {
            name: "AutoCare Demo",
            ...
            distance: 0.6,
            rating: 4.3,
            categories: ["auto_repair", "automotive"],
          },
        ],
        healthcare: [
          {
            ...
            distance: 0.3,
            rating: 4.7,
            categories: ["healthcare", "primary_care"],
          },
          {
          ...
          },
          {
            ...
            distance: 0.4,
            rating: 4.5,
            categories: ["healthcare", "optometry"],
          },
          {
          ...
          },
          {
            ...
            distance: 0.6,
            rating: 4.4,
            categories: ["healthcare", "urgent_care"],
          },
          {
        ...
        recreation: [
          ...
          {
            name: "Aquatic Center Demo",
            category: "Swimming Pool",
            distance: 0.6,
            rating: 4.6,
            categories: ["recreation", "swimming"],
          },
          {
            name: "Demo Youth Soccer Fields",
            category: "Soccer Fields",
            distance: 0.8,
            rating: 4.5,
            categories: ["recreation", "soccer"],
          },
          {
            ...
            distance: 0.3,
            rating: 4.8,
            categories: ["recreation", "walking"],
          },
          {
            name: "Demo Community Garden",
            category: "Community Garden",
            distance: 0.5,
            rating: 4.4,
            categories: ["recreation", "gardening"],
          },
          {
            ...
            distance: 0.2,
            rating: 4.7,
            categories: ["recreation", "playground"],
          },
        ],
        agentTalkingPoints: [
      ...
      safety: {
        ...
        safetyServices: [
          ...
          {
            name: "Fire Department Station 7",
            category: "Fire Department",
            distance: 0.6,
            rating: 4.7,
            categories: ["fire_department", "emergency"],
          },
          {
            name: "Demo Emergency Medical",
            category: "EMS",
            distance: 0.3,
            rating: 4.6,
            categories: ["emergency_medical", "healthcare"],
          },
          {
            name: "Community Watch HQ",
            category: "Security",
            distance: 0.2,
            rating: 4.5,
          ...
          },
          {
            ...
            distance: 0.8,
            rating: 4.4,
            categories: ["shelter", "social_services"],
          },
        ],
        agentSafetyPitch: [
        ...
        schools: [
          {
            ...
            distance: 0.3,
            rating: 9.2,
            categories: ["school", "elementary"],
          },
          {
            name: "Central Demo Middle School",
            category: "Middle School",
            distance: 0.6,
            rating: 9.0,
            categories: ["school", "middle"],
          },
          {
          ...
          },
          {
            ...
            distance: 0.2,
            rating: 8.8,
            categories: ["school", "preschool"],
          },
          {
            name: "Demo Montessori Academy",
            category: "Private School",
            distance: 0.5,
            rating: 9.1,
            categories: ["school", "private"],
          },
          {
            name: "STEM Innovation Charter",
            category: "Charter School",
            distance: 0.9,
            rating: 9.3,
            categories: ["school", "charter"],
          },
          {
            ...
            distance: 1.2,
            rating: 8.9,
            categories: ["university", "higher_education"],
          },
          {
            name: "Community College Demo",
      ...
      transportation: {
        ...
        commuteOptions: [
          ...
          {
            name: "Demo Bus Terminal",
            category: "Bus Station",
            distance: 0.2,
            rating: 4.4,
            categories: ["transit", "bus"],
          },
          {
            ...
            distance: 0.1,
            rating: 4.5,
            categories: ["bike_share", "transportation"],
          },
          {
            name: "Demo Taxi Stand",
            category: "Taxi",
            distance: 0.3,
            rating: 4.2,
            categories: ["taxi", "transportation"],
          },
          {
            name: "Car2Go Station",
            category: "Car Share",
            distance: 0.2,
            rating: 4.3,
            categories: ["car_share", "transportation"],
          },
          {
            name: "Demo Ferry Terminal",
            category: "Ferry",
            distance: 1.5,
            rating: 4.7,
            categories: ["ferry", "water_transport"],
          },
          {
            name: "Express Bus Stop",
            category: "Express Bus",
            distance: 0.3,
            rating: 4.5,
            categories: ["bus", "express_transit"],
          },
          {
            name: "Park & Ride Lot",
            category: "Parking",
