...
export class InspectorSearchService {
  private static readonly MOCK_INSPECTORS: Inspector[] = [
    {
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Extremely thorough inspection. Found issues that saved me thousands. Highly professional and detailed report delivered same day.',
          date: '2024-01-15',
          verified: true,
          projectType: 'general',
          helpfulCount: 8
        },
        {
          ...
          rating: 5,
          comment: 'Michael was punctual, professional, and very knowledgeable. The report was comprehensive and easy to understand.',
          date: '2024-01-08',
          verified: true,
          projectType: 'general',
          helpfulCount: 5
        },
        {
          ...
          rating: 5,
          comment: 'Found a major foundation issue that could have cost us $20K+. Worth every penny and more!',
          date: '2024-01-02',
          verified: true,
        ...
        },
        {
          ...
          rating: 4,
          comment: 'Very thorough inspection. Report was detailed but took longer than expected to receive.',
          date: '2023-12-28',
          verified: true,
          projectType: 'general',
          helpfulCount: 3
      ...
      portfolio: [
        {
          ...
          description: 'Comprehensive inspection of 1920s colonial home including detailed foundation and electrical assessment.',
          beforeImages: ['/api/placeholder/400/300'],
          afterImages: [],
          completionDate: '2024-01-10',
          clientTestimonial: 'Saved us from a major foundation issue. Worth every penny!'
        },
        {
          id: 'portfolio-2',
          title: 'New Construction Final Inspection - North Hills',
          description: 'Final walkthrough inspection of newly constructed luxury home with detailed punch list and system testing.',
          beforeImages: ['/api/placeholder/400/300', '/api/placeholder/400/300'],
          afterImages: [],
          completionDate: '2024-01-15',
          clientTestimonial: 'Caught 15+ items the builder missed. Professional and thorough service.'
        },
        {
          id: 'portfolio-3',
          title: 'Pre-Purchase Inspection - Cary Family Home',
          description: 'Complete inspection of 1990s family home including radon testing and pest inspection.',
          beforeImages: ['/api/placeholder/400/300'],
          afterImages: [],
          completionDate: '2024-01-05',
          clientTestimonial: 'Report was incredibly detailed and helped us negotiate $5K off the price.'
        }
      ],
      
      specialties: ['Historic Homes', 'Foundation Issues', 'Electrical Systems', 'Pest Detection'],
      ...
      inspectionTypes: ['general', 'pest', 'termite', 'radon', 'structural', 'electrical', 'plumbing', 'hvac'],
      equipmentOwned: ['Thermal Camera', 'Moisture Meter', 'Gas Detector', 'Electrical Tester'],
    ...
    },
    {
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Best inspector in the Triangle area. Very detailed and patient in explaining findings.',
          date: '2024-01-12',
          verified: true,
          projectType: 'general',
          helpfulCount: 12
      ...
      portfolio: [
        {
          ...
          description: 'Final walkthrough inspection of new construction home with detailed punch list.',
          beforeImages: ['/api/placeholder/300/200'],
          afterImages: [],
          completionDate: '2024-01-05',
          clientTestimonial: 'Caught several issues the builder missed. Very professional service.'
        }
      ],
      
      specialties: ['New Construction', 'Radon Testing', 'Commercial Properties', 'Mold Assessment'],
      serviceAreas: ['Durham', 'Chapel Hill', 'Hillsborough', 'Durham County', 'Orange County'],
      verified: true,
      ...
      inspectionTypes: ['general', 'pest', 'termite', 'radon', 'mold', 'structural', 'electrical', 'plumbing', 'hvac', 'commercial'],
      equipmentOwned: ['Thermal Camera', 'Moisture Meter', 'Radon Detector', 'Mold Test Kit', 'Electrical Tester'],
      ...
      reviews: [
        {
          ...
          rating: 5,
          comment: 'Amanda was fantastic! Very detailed report with photos and explanations. Highly recommend.',
          date: '2024-01-18',
          verified: true,
          projectType: 'general',
          helpfulCount: 7
        },
        {
          ...
          rating: 4,
          comment: 'Good inspection overall. Found some minor issues we hadn\'t noticed.',
          date: '2024-01-12',
          verified: true,
          projectType: 'general',
          helpfulCount: 4
      ...
      portfolio: [
        {
          ...
          description: 'Detailed inspection of 2015 townhome with focus on HVAC and plumbing systems.',
          beforeImages: ['/api/placeholder/400/300'],
          afterImages: [],
          completionDate: '2024-01-20',
          clientTestimonial: 'Very professional and thorough. Great communication throughout.'
        }
      ],
   ...
   */
  static async searchInspectors(criteria: InspectorSearchCriteria): Promise<ServiceSearchResult[]> {
    try {
      ...
      let results = this.MOCK_INSPECTORS.filter(inspector => {
        ...
        if (criteria.insuredOnly && inspector.insurance.length === 0) return false;
        if (criteria.minRating && inspector.overallRating < criteria.minRating) return false;
      ...
      const errorResult = errorHandlingService.handleError(error, 'InspectorSearchService.searchInspectors');
  ...
  static async getInspectorById(id: string): Promise<Inspector | null> {
    try {
      ...
      return this.MOCK_INSPECTORS.find(inspector => inspector.id === id) || null;
    } catch (error) {
      console.error('Error getting inspector:', error);
      const errorResult = errorHandlingService.handleError(error, 'InspectorSearchService.getInspectorById');
      throw new Error(errorResult.userMessage);
    }
  }
  ...
  static async bookInspection(
    ...
    try {
      ...
      const errorResult = errorHandlingService.handleError(error, 'InspectorSearchService.bookInspection');
      throw new Error(errorResult.userMessage);
    }
  }
   ...
   */
  static async getAvailableSlots(inspectorId: string, date: string): Promise<string[]> {
    try {
      ...
      const errorResult = errorHandlingService.handleError(error, 'InspectorSearchService.getAvailableSlots');
      throw new Error(errorResult.userMessage);
    }
  }
   ...
   */
  static filterInspectors(inspectors: Inspector[], filters: ServiceSearchFilters): Inspector[] {
    return inspectors.filter(inspector => {
      if (filters.rating && (inspector.overallRating < filters.rating.min || inspector.overallRating > filters.rating.max)) {
        return false;
      }
      
      if (filters.pricing && (inspector.standardInspectionFee < filters.pricing.min || inspector.standardInspectionFee > filters.pricing.max)) {
        return false;
      }
  ...
  private static calculateMatchScore(inspector: Inspector, criteria: InspectorSearchCriteria): number {
   ...
   */
  static createSearchCriteriaFromListing(listing: Listing): Partial<InspectorSearchCriteria> {
    return {
      ...
      propertyAge: listing.yearBuilt ? new Date().getFullYear() - listing.yearBuilt : undefined,
