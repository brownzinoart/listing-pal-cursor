...
export const fetchPropertyDetails = async (address: string): Promise<any> => {
  ...
  try {
    ...
    console.log(
      "⚠️ Property details lookup requires coordinates. Consider implementing address geocoding first.",
    );
    ...
    return {
      ...
      _message:
        "Property details available via ATTOM API. Address geocoding required.",
    };
  } catch (error) {
