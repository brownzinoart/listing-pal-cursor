  ...
  async createSlideshow(
    ...
    try {
      ...
      if (!audioUrl) {
        ...
        resourceManagementService.registerResource("blob_url", videoUrl, {
          type: "video",
          size: videoBlob.size,
        });
        return videoUrl;
      ...
      try {
        ...
        resourceManagementService.registerResource("blob_url", mergedUrl, {
        ...
        resourceManagementService.registerResource("blob_url", fallbackUrl, {
          type: "video_fallback",
          size: videoBlob.size,
        });
        return fallbackUrl;
