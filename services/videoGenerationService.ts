...
class VideoGenerationService {
  ...
  async generateScript(listing: Listing, analysis: VideoAnalysis, style: string = 'modern'): Promise<VideoScript> {
    ...
    return {
      ...
      totalDuration: scenes.reduce((sum, scene) => sum + scene.duration, 0) + 10 // +10 for intro/outro
    };
  }
  ...
  async generateVideo(
    ...
    try {
      ...
      try {
        ...
        console.error('Remotion video generation failed, falling back to FFmpeg.wasm:', error);
      ...
      return {
        ...
        platformVersions: {
          ...
          instagram: { url: `/api/videos/${videoId}/instagram.mp4`, duration: 90 },
      ...
      return {
        ...
        platformVersions: {
          tiktok: { url: `/api/videos/${videoId}/tiktok.mp4`, duration: 60 },
          instagram: { url: `/api/videos/${videoId}/instagram.mp4`, duration: 90 },
          youtube: { url: `/api/videos/${videoId}/youtube.mp4`, duration: script.totalDuration }
        }
      };
    }
  }
