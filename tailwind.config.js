...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "brand-gradient-3":
          "linear-gradient(90deg, #805AD5 0%, #4A55C7 50%, #38A169 100%)",
      ...
      backgroundImage: {
        ...
        "brand-gradient-radial":
          "radial-gradient(ellipse at center, #4A55C7, #805AD5)",
      },
      borderRadius: {
        sm: "0.5rem",
        md: "0.75rem",
      ...
      boxShadow: {
        ...
        brand:
          "0 4px 6px -1px rgba(74, 85, 199, 0.1), 0 2px 4px -1px rgba(74, 85, 199, 0.06)",
        "brand-md":
          "0 10px 15px -3px rgba(74, 85, 199, 0.1), 0 4px 6px -2px rgba(74, 85, 199, 0.05)",
        "brand-lg":
          "0 20px 25px -5px rgba(74, 85, 199, 0.1), 0 10px 10px -5px rgba(74, 85, 199, 0.04)",
  ...
  safelist: [
    {
      pattern:
        /bg-(brand-background|brand-panel|brand-card|brand-primary|brand-secondary|brand-accent|brand-danger|brand-warning|brand-info|brand-success|brand-input-bg)/,
    },
    {
      pattern:
        /text-(brand-text-primary|brand-text-secondary|brand-text-tertiary|brand-primary|brand-secondary|brand-accent|brand-danger|brand-warning|brand-info|brand-success)/,
    },
    {
      pattern:
        /border-(brand-border|brand-primary|brand-secondary|brand-danger|brand-warning|brand-info|brand-success)/,
    },
    {
