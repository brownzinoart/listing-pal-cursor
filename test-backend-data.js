...
const testBackendData = {
  ...
  addTestRoomDesign(listingId, testImageUrl = 'https://picsum.photos/400/300') {
    ...
    console.log('📊 Total room designs now:', listings[listingIndex].generatedRoomDesigns.length);
  ...
  listAllWithStatus() {
    ...
    listings.forEach(listing => {
      ...
      console.log(`   Description: ${listing.generatedDescription ? '✅' : '❌'}`);
      console.log(`   Email: ${listing.generatedEmail ? '✅' : '❌'}`);
      console.log(`   Facebook: ${listing.generatedFacebookPost ? '✅' : '❌'}`);
      console.log(`   Instagram: ${listing.generatedInstagramCaption ? '✅' : '❌'}`);
      console.log(`   X/Twitter: ${listing.generatedXPost ? '✅' : '❌'}`);
      console.log(`   Room Designs: ${listing.generatedRoomDesigns?.length || 0} designs`);
